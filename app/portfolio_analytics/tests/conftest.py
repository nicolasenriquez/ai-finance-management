"""Pytest fixtures for portfolio-analytics integration tests."""
...
async def _assert_required_tables_exist(*, session: AsyncSession) -> None:
    ...
    pytest.fail(
        "Portfolio-analytics integration tests require migrated tables. "
...
async def test_db_engine() -> AsyncGenerator[AsyncEngine, None]:
    """Create a fresh database engine for each portfolio-analytics test."""
...
async def test_db_session(
    ...
    """Create a fresh database session for each portfolio-analytics test."""
