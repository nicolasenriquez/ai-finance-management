...
- Enforce duplicate-safe transaction persistence using deterministic fingerprints derived from stable canonical business fields plus provenance fallback for dataset 1 event types.
