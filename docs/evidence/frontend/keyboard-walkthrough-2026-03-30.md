# Frontend Keyboard Walkthrough - 2026-03-30
...
- Workspace analytics tab is keyboard-reachable: `FAIL`
- Enter on analytics tab navigates to analytics route: `FAIL`
- Workspace risk tab is keyboard-reachable: `FAIL`
- Enter on risk tab navigates to risk route: `FAIL`
...
6. a.workspace-nav__link | role=n/a | label=Analytics (Preview)
7. a.workspace-nav__link | role=n/a | label=Risk (Interpretation)
8. a.workspace-nav__link | role=n/a | label=Quant/Reports

## Raw Evidence

- JSON report: `docs/evidence/frontend/keyboard-walkthrough-2026-03-30.json`
