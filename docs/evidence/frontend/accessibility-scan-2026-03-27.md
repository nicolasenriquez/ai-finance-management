# Frontend Accessibility Scan - 2026-03-27
...
- `2.4.7 Focus Visible`: paired with keyboard walkthrough evidence in `docs/evidence/frontend/keyboard-walkthrough-2026-03-27.md`.
...
- JSON report: `docs/evidence/frontend/accessibility-scan-2026-03-27.json`
