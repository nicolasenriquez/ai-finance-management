...
export function PortfolioAnalyticsPage() {
  ...
  return (
    <PortfolioWorkspaceLayout
      ...
      title="Benchmark-relative performance narrative"
      description="Performance route ordered as benchmark-aware overview, contribution drill-down, and evidence surfaces with progressive disclosure for advanced modules."
      actions={
        <>
