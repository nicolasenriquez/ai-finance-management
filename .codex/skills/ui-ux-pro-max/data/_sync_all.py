...
NEW_COLORS = {
    ...
    "Todo & Task Manager": (
        ...
        "#059669",
        "#F8FAFC",
        "Functional blue + progress green",
    ),
    "Personal Finance Tracker": (
        ...
        "#059669",
        "#0F172A",
        "Trust blue + profit green on dark",
    ),
    "Chat & Messaging App": (
        "#2563EB",
        "#6366F1",
    ...
    "Translator App": (
        ...
        "#EA580C",
        "#F8FAFC",
        "Global blue + teal + accent orange",
    ),
    ...
    "Alarm & World Clock": (
        ...
        "#6366F1",
        "#0F172A",
        "Time amber + night indigo on dark",
    ),
    ...
    "Arcade & Retro Game": (
        ...
        "#22C55E",
        "#0F172A",
        "Neon red+blue on dark + score green",
    ),
    # ── C. Creator Tools ──
    "Photo Editor & Filters": (
        ...
        "#0891B2",
        "#0F172A",
        "Editor violet + filter cyan on dark",
    ),
    "Short Video Editor": (
        "#EC4899",
        "#DB2777",
        "#2563EB",
        "#0F172A",
        "Video pink on dark + timeline blue",
    ),
    "Drawing & Sketching Canvas": (
        ...
        "#0891B2",
        "#1C1917",
        "Canvas purple + tool teal on dark",
    ),
    ...
    "Meme & Sticker Maker": (
        ...
        "#2563EB",
        "#FFFFFF",
        "Viral pink + comedy yellow + share blue",
    ),
    ...
    "Running & Cycling GPS": (
        ...
        "#059669",
        "#0F172A",
        "Energetic orange + pace green on dark",
    ),
    ...
    "Sleep Tracker": (
        ...
        "#7C3AED",
        "#0F172A",
        "Night indigo + dream violet on dark",
    ),
    ...
    "Parking Finder": (
        ...
        "#DC2626",
        "#F0F9FF",
        "Available blue/green + occupied red",
    ),
    ...
    "Wallpaper & Theme App": (
        ...
        "#2563EB",
        "#FAF5FF",
        "Aesthetic purple + trending pink",
    ),
    "White Noise & Ambient Sound": (
        ...
        "#4338CA",
        "#0F172A",
        "Ambient grey + deep indigo on dark",
    ),
...
def rebuild_colors():
    ...
    for i, prod in enumerate(products, 1):
        ...
        if pt in color_map:
            ...
            new_row = derive_row(
                pt, "#2563EB", "#3B82F6", "#059669", "#F8FAFC", "Auto-generated default"
            )
            d = dict(zip(headers, [str(i)] + new_row))
            final_rows.append(d)
            added += 1
